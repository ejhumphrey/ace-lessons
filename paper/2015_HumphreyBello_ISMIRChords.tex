...
% Adopting more of a tagging approach would also help lead to more stable evaluation, and
...
% Build ACE systems to solicit feedback
% Combine multiple chord labels
% Leverage the internet for data
